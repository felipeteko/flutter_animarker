...
class AnilocationTaskImpl extends IAnilocationTask with AnilocationTaskInitializer {
  ...
  void _locationListener() {
    if (description.latLngListener != null) {
      ...
      if ((wrapper.locationTween.begin.bearing - wrapper.locationTween.end.bearing).abs() > 180) {
        ...
        if (wrapper.locationTween.begin.bearing > wrapper.locationTween.end.bearing) {
          // clock wise
          ...
          if (bearing > wrapper.locationTween.begin.bearing || bearing < wrapper.locationTween.end.bearing) {
            description.latLngListener!(_proxyAnim.value.copyWith(bearing: bearing));
          } else {
            description.latLngListener!(_proxyAnim.value.copyWith(bearing: wrapper.locationTween.end.bearing));
          }
        } else {
          /// anti-clock wise
          bearing = bearing - complatedRotation;
